...
public class AddCityFragment2 extends DialogFragment {

    private static final String ARG_CITY = "city";
    private City city; // null if adding

    public static AddCityFragment2 newInstance(City city) {
        Bundle args = new Bundle();
        args.putSerializable(ARG_CITY, city);
        AddCityFragment2 fragment = new AddCityFragment2();
